...
typedef struct {
    ...
    uint32_t opcode_31_10;
    uint32_t opcode_31_22;
    int rd;
    int rn;
    int rm;
...
#define OPCODE_ADDS_IMM   0xB1  // ADDS Xd, Xn, #imm
#define OPCODE_ADDS_EXT   0x558 // ADDS Xd, Xn, Xm
#define OPCODE_ADD_IMM    0x91  // ADD Xd, Xn, #imm
#define OPCODE_ADD_EXT    0x458 // ADD Xd, Xn, Xm
#define OPCODE_SUBS_IMM   0xF1  // SUBS Xd, Xn, #imm
...
#define OPCODE_BR         0x3587C0 // bits 31–10 para instrucción BR
#define OPCODE_BL         0x25  // bits 31–26
#define OPCODE_B_COND     0x54  // bits 31–24
#define OPCODE_LSL_R_IMM  0x34D // bits 31-22
#define INT_OPCODE_LSR    0xFFA // opcode 31–22 según ensamblado real
#define INT_OPCODE_LSL    0xFFF // Valor especial que vamos a usar internamente
#define OPCODE_LDUR       0x7C2 // bits 31–21 para LDUR X
...
#define OPCODE_CBZ        0xB4 // Opcode for CBZ instruction
#define OPCODE_CBNZ       0xB5 // Opcode for CBNZ instruction
